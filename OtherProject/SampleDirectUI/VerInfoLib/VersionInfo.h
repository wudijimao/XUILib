...
class VER_INFO_DECLSPEC CVersionInfo : public CObject  
{
public:
	...
	BOOL ToFile(const CString& strModulePath = L"", LPCTSTR lpszResourceId = NULL /*Auto*/, WORD wLangId = 0xFFFF /*Auto*/);

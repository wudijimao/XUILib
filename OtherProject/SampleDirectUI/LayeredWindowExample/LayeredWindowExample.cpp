// LayeredWindowExample.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "LayeredWindowExample.h"
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_LAYEREDWINDOWEXAMPLE, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAYEREDWINDOWEXAMPLE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LAYEREDWINDOWEXAMPLE));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_LAYEREDWINDOWEXAMPLE);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		// TODO:  在此添加任意绘图代码...
		mBkgGraphics->Clear(Gdiplus::Color::AliceBlue);
